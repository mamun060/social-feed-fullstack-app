            ...
            <div className="container _custom_container">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        ...
                        <li className="nav-item _header_nav_item">
                            <Link href="/friend-request" className="nav-link _header_nav_link" aria-current="page">
                            ...
                            <div id="_notify_drop" className={`_notification_dropdown ${showNotifications ? '_active' : ''}`}>
                                ...
                                <div className="_notifications_drop_box">
                                    ...
                                    <div className="_notifications_all">
                                        ...
                                        <div className="_notification_box">
                                            <div className="_notification_image">
                                                <img src="/images/profile-1.png" alt="Image" className="_notify_img" />
                                            </div>
                                            <div className="_notification_txt">
                                                <p className="_notification_para">
                                        ...
                                        {/* Additional notification items omitted for brevity, but they follow the same structure as above */}
                                         <div className="_notification_box">
                                            <div className="_notification_image">
                                                <img src="/images/friend-req.png" alt="Image" className="_notify_img" />
                                            </div>
