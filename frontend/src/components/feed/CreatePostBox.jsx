...
const CreatePostBox = () => {
  const ActionButton = ({ icon, label, isMobile }) => (
  ...
  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      ...
      {/*For Desktop*/}
      <div className="_feed_inner_text_area_bottom d-none d-lg-flex">
        <div className="_feed_inner_text_area_item">
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            <ActionButton icon={<PhotoSvg />} label="Photo" />
          </div>
          <div className="_feed_inner_text_area_bottom_video _feed_common">
            <ActionButton icon={<VideoSvg />} label="Video" />
          </div>
          <div className="_feed_inner_text_area_bottom_event _feed_common">
             <ActionButton icon={<EventSvg />} label="Event" />
          </div>
          <div className="_feed_inner_text_area_bottom_article _feed_common">
             <ActionButton icon={<ArticleSvg />} label="Article" />
          </div>
        </div>
        <PostButton />
      </div>
      ...
      <div className="_feed_inner_text_area_bottom_mobile d-lg-none">
        <div className="_feed_inner_text_mobile">
          <div className="_feed_inner_text_area_item">
            <div className="_feed_inner_text_area_bottom_photo _feed_common">
                <ActionButton icon={<PhotoSvg />} isMobile={true} />
            </div>
            <div className="_feed_inner_text_area_bottom_video _feed_common">
                <ActionButton icon={<VideoSvg />} isMobile={true} />
            </div>
            <div className="_feed_inner_text_area_bottom_event _feed_common">
                <ActionButton icon={<EventSvg />} isMobile={true} />
            </div>
            <div className="_feed_inner_text_area_bottom_article _feed_common">
                <ActionButton icon={<ArticleSvg />} isMobile={true} />
            </div>
          </div>
          <PostButton />
        </div>
